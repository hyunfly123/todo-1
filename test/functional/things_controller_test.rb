...
class ThingsControllerTest < ActionController::TestCase
  ...
  test "should create thing" do
    assert_difference('Thing.count') do
      post :create, thing: { assigned: @thing.assigned, description: @thing.description, name: @thing.name }
    end
  ...
  test "should update thing" do
    put :update, id: @thing, thing: { assigned: @thing.assigned, description: @thing.description, name: @thing.name }
    assert_redirected_to thing_path(assigns(:thing))
  end
